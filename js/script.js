...
$(document).ready(function(){
    ...
    $("#tbody-con-leilao a").on("click", function(){
    ...
    $("#btnSalUsuEdi2").on("click", function(){

        var temp = validar_input(["#eNomEdi2","#eCpfEdi2","#eUsuEdi2","#eWhaEdi2","#ePerEdi2"]);
        ...
        if(temp.length){
            ...
            $.ajax({
                ...
                data : {
                    eIdUsu: id_us_temp,
                    eNomUsuEdi: $("#eNomEdi2").val(),
                    eCpfUsuEdi: $("#eCpfEdi2").val(),
                    eUsuUsuEdi: $("#eUsuEdi2").val(),
                    eWhaUsuEdi: $("#eWhaEdi2").val(),
                    ePerUsuEdi: $("#ePerEdi2").val()
                },
                beforeSend : function(){
                    //$("#resultado").html("ENVIANDO...");
                }
    ...
    $("#btnSalSenEdi").on("click", function(){

        var temp = validar_input(["#eSen1Edi1", "#eSen1Edi2"]);

        var s1 = $("#eSen1Edi1").val();
        var s2 = $("#eSen1Edi2").val();

        if(temp.length){
            alerta("Atenção!", "Os campos em vemelhos são obrigatórios!", "error");
            style(temp, "border-color", "red");
        }else if(s1 != s2){
            alerta("Atenção!", "As senhas não conferem, favor, corrigir!", "error");
        }else{

            $.ajax({
                url : "../request/request_atu_senha.php",
                type : 'post',
                data : {
                    eIdUsu: id_us_temp,
                    eSenUsu: s2
