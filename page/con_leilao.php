        ...
        <div class="box-main box-cad-categoria">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-search"></i> Consultar</li>
                </ol>
            </nav>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="tbody-con-leilao">
                            <?php
                                $adm->lei->listarTable01();
                            ?>
                        </tbody>
                    </table>
